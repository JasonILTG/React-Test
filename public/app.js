...
/******/ 	__webpack_require__.p = "C:\\Users\\Jason\\OneDrive\\Programming\\GitHub\\test\\public";
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _BulletAppJs = __webpack_require__(215);

	var _BulletAppJs2 = _interopRequireDefault(_BulletAppJs);

	var _LoginAppJs = __webpack_require__(219);

	var _LoginAppJs2 = _interopRequireDefault(_LoginAppJs);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _BulletContainerJs = __webpack_require__(216);

	var _BulletContainerJs2 = _interopRequireDefault(_BulletContainerJs);

	/* Main app class */

	var BulletApp = (function (_React$Component) {
		_inherits(BulletApp, _React$Component);

		function BulletApp() {
			_classCallCheck(this, BulletApp);

			_get(Object.getPrototypeOf(BulletApp.prototype), 'constructor', this).call(this);
		...
		_createClass(BulletApp, [{
			...
			value: function render() {
				return _react2['default'].createElement(
					...
					_react2['default'].createElement(_BulletContainerJs2['default'], { getNextID: this.getNextID.bind(this) })
				);
			}
		}]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _BulletListJs = __webpack_require__(217);

	var _BulletListJs2 = _interopRequireDefault(_BulletListJs);

	var _InputBulletJs = __webpack_require__(218);

	var _InputBulletJs2 = _interopRequireDefault(_InputBulletJs);

	/* Container for all bullets */

	var BulletContainer = (function (_React$Component) {
		_inherits(BulletContainer, _React$Component);

		function BulletContainer() {
			_classCallCheck(this, BulletContainer);

			_get(Object.getPrototypeOf(BulletContainer.prototype), 'constructor', this).call(this);
			this.state = {
				bullets: []
			};
		}
		...
		_createClass(BulletContainer, [{
			key: 'onBulletSubmit',
			value: function onBulletSubmit(text) {
			...
			value: function render() {
				...
				return _react2['default'].createElement(
					...
					this.state.bullets.map(function (bullet) {
						return _react2['default'].createElement(_BulletListJs2['default'], { text: bullet.text, key: bullet.id, getNextID: _this.props.getNextID });
					}),
					_react2['default'].createElement(
						'ul',
						null,
						_react2['default'].createElement(
							'li',
							null,
							_react2['default'].createElement(_InputBulletJs2['default'], { onSubmit: this.onBulletSubmit.bind(this) })
						)
					)
				);
			}
	...
	exports['default'] = BulletContainer;
	module.exports = exports['default'];
...
/***/ function(module, exports, __webpack_require__) {
	...
	var BulletList = (function (_React$Component) {
		_inherits(BulletList, _React$Component);

		function BulletList() {
			_classCallCheck(this, BulletList);

			_get(Object.getPrototypeOf(BulletList.prototype), 'constructor', this).call(this);
			this.state = {
			...
			value: function render() {
				...
				return _react2['default'].createElement(
					...
					_react2['default'].createElement(
						...
						_react2['default'].createElement(
							'li',
							{ onClick: this.toggleInputDisplay.bind(this) },
							this.props.text
						),
						
						// Map each sub-bullet's text to a BulletList with the text displaed as the first bullet
						this.state.bullets.map(function (bullet) {
							return _react2['default'].createElement(BulletList, { text: bullet.text, key: bullet.id, getNextID: _this.props.getNextID });
						}),
						_react2['default'].createElement(
							'div',
							null,
							this.displayInputBullet()
						)
					)
				);
			}
	...
	module.exports = exports['default'];
	/* Set the text to toggle whether the input bullet is displayed when clicked */ /* Display the input bullet if it is to be displayed */
...
/***/ function(module, exports, __webpack_require__) {
	...
	var InputBullet = (function (_React$Component) {
		_inherits(InputBullet, _React$Component);

		function InputBullet() {
			_classCallCheck(this, InputBullet);

			_get(Object.getPrototypeOf(InputBullet.prototype), 'constructor', this).call(this);
		...
		_createClass(InputBullet, [{
			...
			key: 'submitBullet',
			value: function submitBullet(event) {
			...
			value: function render() {
				return(
					...
					_react2['default'].createElement(
						'form',
						{ className: 'bulletForm', onSubmit: this.submitBullet.bind(this) },
						_react2['default'].createElement('input', { type: 'text', placeholder: 'Type here', value: this.state.text, onChange: this.updateText.bind(this) }),
...
/***/ function(module, exports, __webpack_require__) {
	...
	var LoginApp = (function (_React$Component) {
		...
		_createClass(LoginApp, [{
			key: 'updateUserText',
			value: function updateUserText(event) {
				this.setState({ user: event.target.value });
			}

			/* Called when the password is changed to update the state */
		}, {
			key: 'updatePasswordText',
			value: function updatePasswordText(event) {
			...
			value: function submitLogin(event) {
				...
				fetch('http://localhost:4242/account/verify', {
					...
					if (json.valid) {
						_this.setState({ loginText: 'Success!' });
					} else {
						_this.setState({ loginText: 'Failed :(' });
					}
				});
			...
			value: function render() {
				return _react2['default'].createElement(
					...
					_react2['default'].createElement(
						'form',
						{ className: 'loginForm', onSubmit: this.submitLogin.bind(this) },
						_react2['default'].createElement(
							'p',
							null,
							_react2['default'].createElement('input', { type: 'text', placeholder: 'Username', value: this.state.user, onChange: this.updateUserText.bind(this) })
						),
						_react2['default'].createElement(
							'p',
							null,
							_react2['default'].createElement('input', { type: 'text', placeholder: 'Password', value: this.state.password, onChange: this.updatePasswordText.bind(this) })
						),
						_react2['default'].createElement(
							'p',
							null,
...
/***/ function(module, exports, __webpack_require__) {
	...
	/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(4), (function() { return this; }()), __webpack_require__(221)(module)))
